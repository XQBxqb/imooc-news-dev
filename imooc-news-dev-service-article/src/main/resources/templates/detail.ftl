                ...
                <div class="container-middle">
                    ...
                    <div class="comments-wrapper">
                        ...
                        <div class="comments-words">
                            ...
                            <div class="comments-counts">{{articleReadCount}}条评论</div>
    ...
    <script type="text/javascript">
        ...
        var articleList = new Vue({
            ...
            created() {
                ...
                //获取文章阅读数
                this.articleReadCounts(articleId);
            },
            mounted() {
                // 初始化编辑器
            ...
            methods: {
                ...
                //获取文章阅读数
                articleReadCounts(articleId) {
                    var me = this;

                    var articleServerUrl = app.articleServerUrl;
                    axios.defaults.withCredentials = true;
                    axios.post(articleServerUrl + "/portal/article/articleReadCounts?articleId=" + articleId)
                        .then(res => {
                            // console.log(JSON.stringify(res.data));
                            if (res.data.status == 200) {
                                me.articleReadCount=res.data.data;
                            }
                        });
                },
